...
public class CustomerContactRepositoryIntegrationTest {
    ...
    public void testFindByEmail() {
		...
		aNewContact.setEmail("xyz@myemail.com");
        
		// save test data
		entityManager.persist(aNewContact);

        // Find an inserted record
        CustomerContact foundContact = customerContactRepository.findByEmail("xyz@myemail.com");
        
        assertThat(foundContact.getEmail(), is(equalTo("xyz@myemail.com")));
    }
